...
class BaileysManager {
  private instances: Map<string, IBaileysInstance> = new Map();
  ...
  async createInstance(instanceId: string): Promise<IBaileysInstance> {
  ...
  async deleteInstance(instanceId: string, logout: boolean = true): Promise<void> {
  ...
  listInstances(): BaileysInstanceStatus[] {
    const instanceStatuses: BaileysInstanceStatus[] = [];
