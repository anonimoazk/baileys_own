...
import { createInstance, getInstanceStatus, getInstanceQR, sendMessage, deleteInstance, listInstances, getProfilePicture, sendMediaMessage, reconnectInstance, } from './controllers/instanceController.js';
const router = Router();
