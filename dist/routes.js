...
import { createInstance, getInstanceStatus, getInstanceQR, sendMessage, deleteInstance, disconnectInstance, listInstances, getProfilePicture, sendMediaMessage, reconnectInstance, } from './controllers/instanceController.js';
const router = Router();
